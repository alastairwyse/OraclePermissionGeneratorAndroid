...
{
    /// <include file='InterfaceDocumentationComments.xml' path='doc/members/member[@name="T:OraclePermissionGeneratorWebServiceAPI.ITrackingDataLogger"]/*'/>
    public interface ITrackingDataLogger
    {
        ...
        void Log(DateTime timeStamp, string userIdentifier, string methodName, Location location, byte[] ipV4Address);
    }
}
