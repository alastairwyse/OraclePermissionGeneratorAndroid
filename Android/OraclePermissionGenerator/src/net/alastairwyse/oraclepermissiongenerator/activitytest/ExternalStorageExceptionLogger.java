...
public class ExternalStorageExceptionLogger implements IExceptionLogger {
     ...
     */
    public ExternalStorageExceptionLogger() {
     ...
     */
    public ExternalStorageExceptionLogger(IEnvironment environment, FileWriter exceptionLogFileWriter, IDateProvider dateProvider) {
    ...
    @Override
    public boolean LogException(Context context, Exception exception) {
